...
cancerstage_gender = base.mark_bar().encode(
  ...
  color = alt.Color('gender',title='Gender',scale = alt.Scale(domain=['female','male'], range=["pink1", "SkyBlue1"])), 
...
diagnosisage_gender = base.mark_bar(opacity = 0.8).encode(
  ...
  y = alt.Y(aggregate = "count",title='Count'),
  color = alt.Color('gender',title='Gender',scale = alt.Scale(domain=['female','male'], range=["pink1", "lightskyblue"])), 
