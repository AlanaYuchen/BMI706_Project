...
full_df[full_df['stage'].str.contains("Stage 1.*",regex=True).astype(bool), "stage"] = "Stage I"
full_df[full_df['stage'].str.contains("Stage 2.*",regex=True).astype(bool),  "stage"] = "Stage II"
full_df[full_df['stage'].str.contains("Stage 3.*",regex=True).astype(bool),  "stage"] = "Stage III"
full_df[full_df['stage'].str.contains("Stage 4.*",regex=True).astype(bool),  "stage"] = "Stage IV"

full_df[full_df['stage'].str.contains("I.*",regex=True).astype(bool),  "stage"] = "Stage I"
full_df[full_df['stage'].str.contains("II.*",regex=True).astype(bool),  "stage"] = "Stage II"
full_df[full_df['stage'].str.contains("III.*",regex=True).astype(bool),  "stage"] = "Stage III"
full_df[full_df['stage'].str.contains("IV.*",regex=True).astype(bool),  "stage"] = "Stage IV"

full_df[full_df['stage'].str.contains("Unknown.*",regex=True).astype(bool),  "stage"] = "Not Reported"
full_df[full_df['stage'].str.contains("Not Reported.*",regex=True).astype(bool),  "stage"] = "Not Reported"

full_df[full_df['stage'].str.contains("Stage IIA.*",regex=True).astype(bool),  "stage"] = "Stage IIA"
full_df[full_df['stage'].str.contains("Stage IIIC.*",regex=True).astype(bool),  "stage"] = "Stage IIIC"
full_df[full_df['stage'].str.contains("Stage IIB.*",regex=True).astype(bool),  "stage"] = "Stage IIB"
